...
const ConnectMe = () => {
  ...
  return (
    <Col lg={12}>
      <div className="connectMe-bx wow slideInUp">
        <Row>
          ...
          <Col lg={6}> 
            <div className="contact__data">
                ...
                <span className="contact__button">
                  <a href="https://api.whatsapp.com/send?phone=46707383361&text=Hello" target="_blank" rel="noopener noreferrer">
          ...
          <Col lg={6}>  
            <div className="contact__data">
                ...
                <span className="contact__button">
                  <a href="https://m.me/luxlinnaY" target="_blank" rel="noopener noreferrer">
                    Write me <i className="ri-arrow-right-line"></i>
                  </a>
                </span>
            </div>
